...
public class UnderGraduate extends javax.swing.JPanel {
    ...
    private void add() {
        ...
        StudentDTO dTO=new StudentDTO( AddStudentForm.txtID.getText(),AddStudentForm.course.get(AddStudentForm.cmbCourse.getSelectedIndex()),  AddStudentForm.fac.get(AddStudentForm.cmbfac.getSelectedIndex()), AddStudentForm.txtNIC.getText(), AddStudentForm.txtName.getText(),txtbatch.getText(), AddStudentForm.txtAdd.getText(), AddStudentForm.cmbCal.getSelectedItem()+"",1,AddStudentForm.txtEmail.getText(),AddStudentForm.txtParentName.getText(),AddStudentForm.txtParentMail.getText());
