 ...
 * @author Jinadi
 */
public class ViewUndergraduates extends javax.swing.JPanel {
    ...
    private void selectAll() {
        try {
            ...
            Logger.getLogger(ViewUndergraduates.class.getName()).log(Level.SEVERE, null, ex);
